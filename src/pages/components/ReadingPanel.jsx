...
const ReadingPanel = ({ verse, globalIndex, hideAudio = false, onPrevious, onNext }) => {
  ...
  return (
    <motion.main
      ...
      className="relative z-10 min-w-0 overflow-y-auto bg-transparent pb-28 font-crimson text-text-primary transition-colors duration-500 scrollbar-hide dark:text-dark-text-primary sm:pb-20"
    >
      <div className="mx-auto max-w-[980px] px-4 pt-16 sm:px-8 sm:pt-24">
